...
public class TestsOfIssues extends MainTest {
    private static int index;
    private static String question;
    private static String answer;

    public TestsOfIssues(int index, String question, String answer) {
        TestsOfIssues.index = index;
        TestsOfIssues.question = question;
        TestsOfIssues.answer = answer;
    }
